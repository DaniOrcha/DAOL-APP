        ...
        <div > 
            <div className="bodyContainer">
                ...
                <div className="container">
                    ...
                    <div className="flex">
                        <div className="lensContainer" onMouseOver={() => { imageZoom("iotWeb"); }}>
                        ...
                        <div>
                            <div className="lensContainer" onMouseOver={() => { imageZoom("iot1"); }}>
                                <img id="iot1" src="../resources/iot/iot1.jpg" className="imageIot" alt="err" /> 
                            </div>

                            <div className="lensContainer" onMouseOver={() => { imageZoom("iot2"); }}>
                    ...
                    <div className="flex">
                        <div className="lensContainer left" onMouseOver={() => { imageZoom("iotpanel"); }}>
                        ...
                        <div className="lensContainer" onMouseOver={() => { imageZoom("clkb2"); }}>
